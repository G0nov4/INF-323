...
public class Reina {
    private float vertices[] = new float [] {
            -0.4f,-0.75f,-0.4f,-0.25f,+0.4f,-0.75f,
            +0.4f,-0.75f,-0.4f,-0.25f,+0.4f,-0.25f,
            -0.0f,-0.25f,-0.4f,-0.25f,-0.8f,+0.35f,
            -0.0f,-0.25f,-0.4f,-0.25f,-0.4f,+0.65f,
            -0.2f,-0.25f,+0.2f,-0.25f,-0.0f,+0.95f,
            +0.0f,-0.25f,+0.4f,-0.25f,+0.4f,+0.65f,
            +0.0f,-0.25f,+0.4f,-0.25f,+0.8f,+0.35f
    };
    ...
    public void dibuja(GL10 gl, float col1, float col2, float col3) {
        ...
        gl.glDrawArrays(GL10.GL_TRIANGLES, 0, 21);
