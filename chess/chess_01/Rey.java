...
public class Rey {
    private float vertices[] = new float [] {
            +0.6f,-0.75f,-0.6f,-0.75f,-0.6f,-0.25f,
            -0.6f,-0.25f,+0.6f,-0.25f,+0.6f,-0.75f,
            -0.6f,-0.25f,-0.6f,+0.25f,-0.2f,-0.25f,
            -0.2f,-0.25f,+0.0f,+0.25f,+0.2f,-0.25f,
            +0.2f,-0.25f,+0.6f,+0.25f,+0.6f,-0.25f,
    ...
    public void dibuja(GL10 gl, float col1, float col2, float col3) {
        ...
        gl.glDrawArrays(GL10.GL_LINES, 15, 4);
